...
def basic_image_sampler(alphabet=None, char=None, font=None, background=None, foreground=None, is_slant=None,
    ...
    for i in range(n_symbols):
        ...
        # TODO figure out why translation needs to be subtle like this
        _translation = tuple(rng.rand(2) * 0.8 -0.4 + (0.1, -0.1)) if translation is None else translation
        ...
        symbols.append(synbols.Symbol(
            alphabet=_alphabet, char=_char, font=_font, foreground=_foreground, is_slant=_is_slant, is_bold=_is_bold,
