...
def basic_attribute_sampler(
    ...
    distribution over images. On every call, it will return
    an drawing.Image object, containing every attributes to render
    the final image into a numpy array. All arguments
    to this function have a proper default value. When no arguments
    are passed, this is referred to as the
    "default" synbols dataset.

    All arguments can be either a constant, a callable, or None.
    If None is passed, the default distribution is used.
    A callable can be used to define a distribution over
    the specific argument. This function must take 1 argument
    ...
    Args:
        alphabet: Object of type utils.Alphabet or a distribution over it.
            ...
            Language.get_alphabet(). This argument is only used to specify
    ...
    the width or height cover the whole image. Defaults to
        ...
        translation: a pair of float or a distribution over it.
            ...
            stays withing the image i.e. the actual translation
    ...
    dataset_generator e.g. flatten_mask.
    Returns:
...
def add_occlusion(
    ...
    Args:
        ...
        n_occlusion: integer or a distribution over it.
            Specifies the number of occlusions to draw.
