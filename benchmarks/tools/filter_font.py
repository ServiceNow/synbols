...
parser.add_argument("-cp", "--code_path", type=str, 
...
parser.add_argument("-e", "--experiment_folder", type=str, 
                        default='/mnt/projects/vision_prototypes/synbols/font_plain_borgy/c0160f3a00fbe81b5594720c8b21d352',
...
backbone.load_state_dict(torch.load(os.path.join(args.experiment_folder, 'model.pth'))['model'])
logits = []
labels = []
